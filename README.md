...
##[![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=welcome+To+auto-filter-𝑩𝑶𝑻!;created+by+𝑻𝑬𝑨𝑴+uv!;A+simple+autofilter+Bot!;Auto+filter+with+double+button!;start+message+with+pic!;and+all+futures!)
</p>
